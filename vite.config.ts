...
const jsCookieMjs =
    jsCookieCandidates.find(exists) || "js-cookie/dist/js.cookie.mjs";
...
function MultiRootFailoverResolver() {
    ...
    return {
        ...
        resolveId(id: string, importer?: string) {
            ...
            const isLegacyNs =
                /^(viewmodels|reports|models|views|bindings|utils|plugins|templates)\//.test(
                    id,
                );
            ...
            const basesPerRoot = seg === "templates" ? TMPL_DIR : MEDIA_JS;
            ...
            for (const key of ["bcap", "common", "arches"] as const) {
                ...
                for (const cand of candidates(
                    base,
                    seg === "templates" ? rest : path.join(seg, rest),
                    exts,
                )) {
...
export default defineConfig({
    ...
    resolve: {
        ...
        alias: [
            ...
            {
                find: /^js-cookie\/src\/js\.cookie(?:\.js)?$/,
                replacement: jsCookieMjs,
            },
            // point bare imports to the window-backed shims
            {
                find: /^uuid$/,
                replacement: "/@fs/web_root/bcap/vite-shims/uuid-default.js",
            },
            {
                find: /^jquery$/,
            ...
            {
                find: /^backbone$/,
                replacement: "/@fs/web_root/bcap/vite-shims/backbone-global.js",
            },
            {
                find: /^knockout$/,
                replacement: "/@fs/web_root/bcap/vite-shims/knockout-global.js",
            },
            {
                find: /^knockout-mapping$/,
                replacement:
            ...
            {
                find: /^bootstrap$/,
                replacement: "/@fs/web_root/bcap/vite-shims/noop.js",
            },
            {
                find: /^jqueryui(\/.*)?$/,
                replacement: "/@fs/web_root/bcap/vite-shims/noop.js",
            ...
            // Point the bare 'arches' import at the browser file in the Arches repo
            {
                find: /^arches$/,
                replacement:
                    "/@fs/web_root/arches/arches/app/media/js/arches.js",
            },
            {
                find: /^vue$/,
                replacement:
                    "/@fs/web_root/bcap/node_modules/vue/dist/vue.runtime.esm-bundler.js",
            },
            ...
            // (install if needed: npm i slick-carousel)
            {
                find: /^slick$/,
                replacement:
                    "/@fs/web_root/arches/arches/app/media/plugins/slick/slick.js",
            },
            {
                find: /^chosen$/,
                replacement:
                    "/@fs/web_root/bcap/node_modules/chosen-js/chosen.jquery.js",
            },
            {
                find: /^geojson-extent$/,
                replacement:
                    "/@fs/web_root/bcap/node_modules/@mapbox/geojson-extent/geojson-extent.js",
            },
            {
                find: /^mapbox-gl-geocoder$/,
                replacement:
