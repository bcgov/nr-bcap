"""Which role may reach an endpoint at all, asked before the permission
framework is asked about any one resource. DRF permission classes for API
views, decorators for the plain Django views that ignore permission_classes.
"""
