...
class InvestigationAliases(AbstractAliases):
    ...
    INVESTIGATION_IDENTIFICATION = "investigation_identification"
    ...
    @staticmethod
    def get_aliases():
        return AbstractAliases.get_dict(InvestigationAliases)


class InvestigationGroupAliases(AbstractAliases):
    ...
    @staticmethod
    def get_aliases():
        return AbstractAliases.get_dict(InvestigationGroupAliases)
