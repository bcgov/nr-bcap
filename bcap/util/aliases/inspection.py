...
class InspectionAliases(AbstractAliases):
    ...
    @staticmethod
    def get_aliases():
        return AbstractAliases.get_dict(InspectionAliases)


class InspectionGroupAliases(AbstractAliases):
    ...
    @staticmethod
    def get_aliases():
        return AbstractAliases.get_dict(InspectionGroupAliases)
