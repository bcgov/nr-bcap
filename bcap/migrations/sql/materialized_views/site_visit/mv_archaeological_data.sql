...
-- ---------------------------------------------------------------------
-- archaeological_data  (cardinality 1)  children: archaeological_culture, stratigraphy, additional_site_typology, site_disturbance, chronology, cultural_material, archaeological_feature
-- ---------------------------------------------------------------------
...
WITH archaeological_culture AS (
...
chronology AS (
    SELECT t.parenttileid AS parenttileid,
           jsonb_agg(jsonb_build_object(
            ...
            'start_year', to_date(NULLIF(t.tiledata ->> 'c1f5724c-140b-11f0-898b-0242ac170007', ''), 'YYYY-MM-DD'),
            'information_source', arches_util.i18n_text(t.tiledata -> 'c1f57332-140b-11f0-898b-0242ac170007'),
            'end_year', to_date(NULLIF(t.tiledata ->> 'c1f57418-140b-11f0-898b-0242ac170007', ''), 'YYYY-MM-DD'),
