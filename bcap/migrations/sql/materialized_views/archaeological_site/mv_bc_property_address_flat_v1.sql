...
CREATE UNIQUE INDEX mv_bc_property_address_flat_v1_pk ON archaeological_site.mv_bc_property_address_flat_v1 (resourceinstanceid, site_location_index, bc_property_address_index);
