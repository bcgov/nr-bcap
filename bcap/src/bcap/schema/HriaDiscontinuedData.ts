...
// Allow sortorder: null as seen in your JSON
...
export interface BiogeographyAliasedData {
...
export type BiogeographyTile = NullableSortTile<BiogeographyAliasedData>;

// aliased_data.unreviewed_adif_record
export interface UnreviewedAdifRecordAliasedData {
...
export type UnreviewedAdifRecordTile =
    NullableSortTile<UnreviewedAdifRecordAliasedData>;
...
export interface ArchaeologicalSiteAliasedData {
    archaeological_site:
...
export type ArchaeologicalSiteTile =
    NullableSortTile<ArchaeologicalSiteAliasedData>;

// aliased_data.hria_jursidiction_and_tenure[] (semantic)
export interface HriaJurisdictionAndTenureAliasedData {
...
export type HriaJurisdictionAndTenureTile =
    NullableSortTile<HriaJurisdictionAndTenureAliasedData>;

// aliased_data.chronology[] (semantic)
export interface ChronologyAliasedData {
...
export type ChronologyTile = NullableSortTile<ChronologyAliasedData>;

// aliased_data.site_dimensions
export interface SiteDimensionsAliasedData {
...
export type SiteDimensionsTile = NullableSortTile<SiteDimensionsAliasedData>;

// ====================================================================
// Top-level object for THIS JSON
// ====================================================================
export interface HriaDiscontinuedData {
