"""Contributor API, scoped to the requesting user's own resources: a
...
class ContributorListView(
    ...
    """Collection endpoint for the requesting user's Contributor resources.
...
class ContributorView(
    ...
    """Detail endpoint for a single Contributor resource and its nested tiles.
