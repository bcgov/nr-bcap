"""HCA Permit API, scoped to the requesting user's own resources: a
...
class HcaPermitListView(
    ...
    """Collection endpoint for the requesting user's HCA Permit resources.
...
class HcaPermitView(
    ...
    """Detail endpoint for a single HCA Permit resource and its nested tiles.
