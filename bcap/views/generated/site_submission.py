"""Archaeological Site Submission API, scoped to the requesting user's own resources: a
...
class SiteSubmissionListView(
    ...
    """Collection endpoint for the requesting user's Archaeological Site Submission resources.
...
class SiteSubmissionView(
    ...
    """Detail endpoint for a single Archaeological Site Submission resource and its nested tiles.
