"""Site Visit API, scoped to the requesting user's own resources: a
...
class SiteVisitListView(
    ...
    """Collection endpoint for the requesting user's Site Visit resources.
...
class SiteVisitView(
    ...
    """Detail endpoint for a single Site Visit resource and its nested tiles.
