"""Alteration API, scoped to the requesting user's own resources: a
...
class AlterationListView(
    ...
    """Collection endpoint for the requesting user's Alteration resources.
...
class AlterationView(
    ...
    """Detail endpoint for a single Alteration resource and its nested tiles.
