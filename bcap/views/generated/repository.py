"""Repository API, scoped to the requesting user's own resources: a
...
class RepositoryListView(
    ...
    """Collection endpoint for the requesting user's Repository resources.
...
class RepositoryView(
    ...
    """Detail endpoint for a single Repository resource and its nested tiles.
