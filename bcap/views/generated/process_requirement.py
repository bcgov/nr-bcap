"""Read-only Process Requirement API, scoped to the requesting user's own resources:
a list of the user's Process Requirement resources and a by-id detail fetch.
...
class ProcessRequirementListView(
    ...
    """GET the requesting user's Process Requirement resources.
...
class ProcessRequirementView(
    ...
    """GET a Process Requirement resource and its nested tiles.
