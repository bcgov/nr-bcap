"""Sandcastle API, scoped to the requesting user's own resources: a
...
class ProjectSandboxListView(
    ...
    """Collection endpoint for the requesting user's Sandcastle resources.
...
class ProjectSandboxView(
    ...
    """Detail endpoint for a single Sandcastle resource and its nested tiles.
