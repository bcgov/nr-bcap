"""Legislative Act API, scoped to the requesting user's own resources: a
...
class LegislativeActListView(
    ...
    """Collection endpoint for the requesting user's Legislative Act resources.
...
class LegislativeActView(
    ...
    """Detail endpoint for a single Legislative Act resource and its nested tiles.
