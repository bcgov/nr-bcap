"""Government Person API, scoped to the requesting user's own resources: a
...
class LgPersonListView(
    ...
    """Collection endpoint for the requesting user's Government Person resources.
...
class LgPersonView(
    ...
    """Detail endpoint for a single Government Person resource and its nested tiles.
