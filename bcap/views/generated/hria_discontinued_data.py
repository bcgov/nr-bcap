"""HRIA Discontinued Data API, scoped to the requesting user's own resources: a
...
class HriaDiscontinuedDataListView(
    ...
    """Collection endpoint for the requesting user's HRIA Discontinued Data resources.
...
class HriaDiscontinuedDataView(
    ...
    """Detail endpoint for a single HRIA Discontinued Data resource and its nested tiles.
