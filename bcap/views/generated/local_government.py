"""Government API, scoped to the requesting user's own resources: a
...
class LocalGovernmentListView(
    ...
    """Collection endpoint for the requesting user's Government resources.
...
class LocalGovernmentView(
    ...
    """Detail endpoint for a single Government resource and its nested tiles.
