"""Notice of Project Intent API, scoped to the requesting user's own resources: a
...
class NoticeOfProjectIntentViewMixin(ArchesResourceViewMixin):
    serializer_class = NoticeOfProjectIntentSerializer


@extend_schema(tags=["External: notice_of_project_intent"])
class NoticeOfProjectIntentListView(
    NoticeOfProjectIntentViewMixin,
    UserOwnedResourceMixin,
    ArchesModelAPIMixin,
    ListAPIView,
):
    """Collection endpoint for the requesting user's Notice of Project Intent resources.
...
@extend_schema(tags=["External: notice_of_project_intent"])
class NoticeOfProjectIntentView(
    NoticeOfProjectIntentViewMixin,
    UserOwnedResourceMixin,
    ArchesModelAPIMixin,
    RetrieveAPIView,
):
    """Detail endpoint for a single Notice of Project Intent resource and its nested tiles.
