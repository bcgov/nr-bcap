"""Inspection API, scoped to the requesting user's own resources: a
...
class InspectionListView(
    ...
    """Collection endpoint for the requesting user's Inspection resources.
...
class InspectionView(
    ...
    """Detail endpoint for a single Inspection resource and its nested tiles.
