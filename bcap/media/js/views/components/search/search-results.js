                        ...
                        if (!source.tiles || source.tiles.length === 0) {
                            $.ajax({
                                ...
                                success: function (searchData) {
                                    if (
                                        searchData.results &&
                                        searchData.results.hits &&
                                        searchData.results.hits.hits &&
                                        searchData.results.hits.hits.length > 0
                                    ) {
                                        source.tiles =
                                            searchData.results.hits.hits[0]
                                                ._source.tiles || [];
                                    }
        ...
        updateResults: function () {
            ...
            if (!!this.searchResults.results) {
                ...
                this.searchResults.results.hits.hits.forEach(async function (
                    ...
                    const thumbnailUrl = arches.urls.thumbnail(
