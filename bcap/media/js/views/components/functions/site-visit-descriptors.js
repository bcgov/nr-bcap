...
import defaultSiteDescriptorsTemplate from "templates/views/components/functions/bcap-site-descriptors.htm";
import FunctionViewModel from "viewmodels/function-view-model";

export default ko.components.register(
    "views/components/functions/site-visit-descriptors",
    {
