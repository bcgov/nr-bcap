...
_SV_GRAIN_FLATS = [
    ("bcap", "sv_mv_site_visit_location_flat"),
]
...
_AS_BRANCHES = [
    ...
    ("bcap", "as_mv_heritage_site_location"),
...
_AS_GRAIN_FLATS = [
    ("bcap", "as_mv_heritage_site_location_flat"),
    ("bcap", "as_mv_bc_property_address_flat"),
]
...
sql_items = [
    ...
    SQLItem(
        "sv_mv_resource",
        format_sql("sql/materialized_views/site_visit/mv_resource.sql"),
        reverse_sql="DROP MATERIALIZED VIEW IF EXISTS site_visit.mv_resource CASCADE;",
    ...
    SQLItem(
        ...
        replace=True,
        dependencies=[("bcap", "sv_mv_resource")],
    ),
    SQLItem(
        "sv_refresh_resource",
    ...
    SQLItem(
        "sv_mv_resource_flat",
        format_sql("sql/materialized_views/site_visit/mv_resource_flat.sql"),
        reverse_sql="DROP MATERIALIZED VIEW IF EXISTS site_visit.mv_resource_flat CASCADE;",
        dependencies=[("bcap", "sv_mv_resource")],
    ),
    SQLItem(
        "sv_mv_site_visit_location_flat",
        format_sql("sql/materialized_views/site_visit/mv_site_visit_location_flat.sql"),
        reverse_sql="DROP MATERIALIZED VIEW IF EXISTS site_visit.mv_site_visit_location_flat CASCADE;",
        dependencies=[("bcap", "sv_mv_resource_flat")],
    ),
    SQLItem(
        "sv_flat_views",
        ...
        replace=True,
        dependencies=[("bcap", "sv_mv_resource_flat")] + _SV_GRAIN_FLATS,
    ),
    SQLItem(
        "sv_refresh_flat",
    ...
    SQLItem(
        "as_mv_resource",
        format_sql("sql/materialized_views/archaeological_site/mv_resource.sql"),
        reverse_sql="DROP MATERIALIZED VIEW IF EXISTS archaeological_site.mv_resource CASCADE;",
    ...
    SQLItem(
        ...
        replace=True,
        dependencies=[("bcap", "as_mv_resource")],
    ),
    SQLItem(
        "as_refresh_resource",
    ...
    SQLItem(
        "as_mv_resource_flat",
        format_sql("sql/materialized_views/archaeological_site/mv_resource_flat.sql"),
        reverse_sql="DROP MATERIALIZED VIEW IF EXISTS archaeological_site.mv_resource_flat CASCADE;",
        dependencies=[("bcap", "as_mv_resource")],
    ),
    SQLItem(
    ...
    SQLItem(
        ...
        replace=True,
        dependencies=[("bcap", "as_mv_resource_flat")] + _AS_GRAIN_FLATS,
    ),
    SQLItem(
        "as_refresh_flat",
    ...
    SQLItem(
        "per_mv_resource",
        format_sql("sql/materialized_views/hca_permit/mv_resource.sql"),
        reverse_sql="DROP MATERIALIZED VIEW IF EXISTS hca_permit.mv_resource CASCADE;",
    ...
    SQLItem(
        ...
        replace=True,
        dependencies=[("bcap", "per_mv_resource")],
    ),
    SQLItem(
    ...
    SQLItem(
        "per_mv_resource_flat",
        format_sql("sql/materialized_views/hca_permit/mv_resource_flat.sql"),
        reverse_sql="DROP MATERIALIZED VIEW IF EXISTS hca_permit.mv_resource_flat CASCADE;",
        dependencies=[("bcap", "per_mv_resource")],
    ),
    SQLItem(
        "per_flat_views",
    ...
    SQLItem(
        "pub_mv_resource",
        format_sql("sql/materialized_views/publication/mv_resource.sql"),
        reverse_sql="DROP MATERIALIZED VIEW IF EXISTS publication.mv_resource CASCADE;",
    ...
    SQLItem(
        ...
        replace=True,
        dependencies=[("bcap", "pub_mv_resource")],
    ),
    SQLItem(
    ...
    SQLItem(
        "pub_mv_resource_flat",
        format_sql("sql/materialized_views/publication/mv_resource_flat.sql"),
        reverse_sql="DROP MATERIALIZED VIEW IF EXISTS publication.mv_resource_flat CASCADE;",
        dependencies=[("bcap", "pub_mv_resource")],
    ),
    SQLItem(
        "pub_flat_views",
    ...
    SQLItem(
        "rep_mv_resource",
        format_sql("sql/materialized_views/repository/mv_resource.sql"),
        reverse_sql="DROP MATERIALIZED VIEW IF EXISTS repository.mv_resource CASCADE;",
    ...
    SQLItem(
        ...
        replace=True,
        dependencies=[("bcap", "rep_mv_resource")],
    ),
    SQLItem(
    ...
    SQLItem(
        "rep_mv_resource_flat",
        format_sql("sql/materialized_views/repository/mv_resource_flat.sql"),
        reverse_sql="DROP MATERIALIZED VIEW IF EXISTS repository.mv_resource_flat CASCADE;",
        dependencies=[("bcap", "rep_mv_resource")],
    ),
    SQLItem(
        "rep_flat_views",
