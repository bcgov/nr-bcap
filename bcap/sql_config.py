...
sql_items = [
    SQLItem(
        ...
        format_sql(
            "sql/views/bc_labelled_geojson_geometries.sql",
        ),
    ...
    SQLItem(
        ...
        format_sql(
            "sql/views/bc_labelled_site_geometries.sql",
        ),
    ...
    SQLItem(
        ...
        format_sql(
            "sql/views/bc_labelled_site_visit_geometries.sql",
        ),
    ...
    SQLItem(
        ...
        format_sql(
            "sql/views/bc_labelled_sandcastle_geometries.sql",
        ),
