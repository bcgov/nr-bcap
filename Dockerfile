...
RUN pip install -e .[dev] && \
    pip install python-dotenv clamd boto3==1.26 django-storages==1.13 oracledb html2text cffi redis drf-spectacular==0.29.0 djangorestframework-dataclasses==1.4.0 faker && \
